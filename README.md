...
```powershell
Get-AuthenticodeSignature "$env:USERPROFILE\Downloads\genyo-point-automation-setup-v1.0.7-win32-x64.exe" | Format-List
```
...
Path                   : C:\Users\<your-user>\Downloads\genyo-point-automation-setup-v1.0.7-win32-x64.exe
